...
#### <i>1) locate package dependencies and create `renv` folder</i>
...
#### <i>2) list packages in project library</i>
...
#### <i>3) write `renv.lock` file and restart R</i>
...
### Stores packages in project-local private library

```{r renv-init-pkgs-01.png, echo=FALSE, out.width='49%', fig.align='center'}
...
```{r renv-init-pkgs-02.png, echo=FALSE, out.width='69%', fig.align='center'}
...
### `renv::dependencies()` searches your project files looking for packages and related files



```{r renv-depend.png, echo=FALSE, out.width='60%', fig.align='center'}
knitr::include_graphics("img/renv-depend.png")
```
...
### [`targets` (talk)](https://www.youtube.com/watch?v=Gqn7Xn4d5NI) Reproducible Computation at Scale in R with Targets
