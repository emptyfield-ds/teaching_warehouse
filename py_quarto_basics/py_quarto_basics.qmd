---
title: "Dynamic documents in Python"
...
#| out.width: 25%
#| layout-ncol: 2
knitr::include_graphics("img/new_document_button.png")
...
See the [Quarto documentation](https://quarto.org/docs/reference/cells/cells-jupyter.html)
...
First-class support for [R](https://quarto.org/docs/computations/r.html), [Julia](https://quarto.org/docs/computations/julia.html), and [Observable JS](https://quarto.org/docs/computations/ojs.html)
...
knitr::include_graphics("img/chunk_setup_gui2.png")
```
...
```bash
quarto render document.qmd -P param1:0.2 -P param2:0.3
```
