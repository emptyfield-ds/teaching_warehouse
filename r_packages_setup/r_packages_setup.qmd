...
## [devtools](https://devtools.r-lib.org/) {background-image="http://hexb.in/hexagons/devtools.png" background-position="90% 3%" background-size="15%"}

## Tools to make an R developer's life easier
## We'll be using functions like *`load_all()`*, *`build()`*, *`document()`*, *`test()`*, and *`check()`*.

## [usethis](https://usethis.r-lib.org/) {background-image="https://raw.githubusercontent.com/r-lib/usethis/master/man/figures/logo.png" background-position="90% 3%" background-size="15%"}

## Set up commonly used 📦 components
## We'll be using functions like *`create_package()`*, *`use_r()`*, *`use_test()`*, and many more.

## shinRa {background-image="img/hex-shinRa.png" background-position="90% 3%" background-size="15%"}
...
## avalanchr {background-image="img/hex-avalanchr.png" background-position="90% 10%" background-size="30%"}
::: {.column width="50%"}
...
::: {.column width="50%"}Image from the [available repository:::(https://github.com/r-lib/available)]
...
::: {.column width="50%"}image from [R Packages, ed. 2:::(https://r-pkgs.org/description.html)]
