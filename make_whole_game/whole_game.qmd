...
from functions import table_brazil_causes
```
...
# pickling is not well-supported in GT yet
# see https://github.com/posit-dev/great-tables/issues/640
# so in the meantime, we'll use the pickle file as a proxy to track
# this dependency, even though we are recreating the table here.
brazil_causes_2010 = brazil_causes_2010.collect()
table_brazil_causes(brazil_causes_2010)
```
