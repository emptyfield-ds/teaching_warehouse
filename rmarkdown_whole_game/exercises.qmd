...
*For this set of exercises, we'll work through an R Markdown report in `whole_game.qmd`. Open up that file and follow along with these exercises:*

## *Your Turn 1*

1.  *Turn on Visual R Markdown mode for `exercises.qmd` (this document) AND `whole_game.qmd`*
...
3.  *At the top of the document, change `format: html` to this code (be mindful to keep the indents as is):*
