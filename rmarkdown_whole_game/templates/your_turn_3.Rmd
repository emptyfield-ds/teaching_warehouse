...
```{r descriptive-stats, eval = FALSE, echo = FALSE}
...
```{r table-one, eval = FALSE, echo = FALSE, message = FALSE, warning = FALSE}
lbls <- list(
...
diabetes %>% 
  ...
  _______(by = diabetic, label = lbls, missing_text = "(Missing)") %>% 
  _______()
```
