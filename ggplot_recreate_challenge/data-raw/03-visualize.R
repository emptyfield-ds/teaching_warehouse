...
my_theme <- theme(
  ...
  axis.text = element_text(family = "Ubuntu", size = 7),

  axis.title = element_text(family = "Ubuntu", size = 11),

  panel.border = element_blank(),

  strip.background = element_blank(),

  plot.title = element_text(family = "Verdana", size = 15)
)
