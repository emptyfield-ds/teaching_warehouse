...
knitr::include_graphics("rmarkdown_components.png")
```
...
## Do the ten minute tutorial on markdown at https://commonmark.org/help/tutorial. Let us know if you need help!
...
```{r, echo = FALSE, out.height="100%", out.width="100%"}
  knitr::include_graphics("code_chunk_fences.png")
```
...
```{r, echo = FALSE, out.height="100%", out.width="100%"}
  knitr::include_graphics("code_chunk_opts.png")
```
...
knitr::include_graphics("rmarkdown_knit.png")
```
...
```{r, echo = FALSE, out.height="100%", out.width="100%"}
knitr::include_graphics("chunk_setup_gui.png")
```
...
knitr::include_graphics("inline_code.png")
```
...
```{r, echo = FALSE, out.height="75%", out.width="75%"}
knitr::include_graphics("inline_code_highlight.png")
```
...
```{r, echo = FALSE, out.height="100%", out.width="100%"}
knitr::include_graphics("yaml_example.png")
```

---

```{r, echo = FALSE, out.height="100%", out.width="100%"}
knitr::include_graphics("yaml_example_noted.png")
```

---

```{r, echo = FALSE, out.height="100%", out.width="100%"}
knitr::include_graphics("yaml_example_noted2.png")
```

---

```{r, echo = FALSE, out.height="100%", out.width="100%"}
knitr::include_graphics("yaml_example_noted3.png")
```
