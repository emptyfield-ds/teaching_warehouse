...
We're going to explore a dataset about energy use in Europe from 2016 to 2018.  This dataset was the subject of Tidy Tuesday the week of 2020-08-04. You can find more details here: https://github.com/rfordatascience/tidytuesday/blob/master/data/2020/2020-08-04/readme.md.
...
3. Add points. We'll use a hollow shape so we can change the border color of the points. Set the shape to 21, the fill to "steelblue", and the size to 2.
...
* Include both the code (in this R Markdown file or a separate R script) and a `.png` file created with `ggsave()`. 
