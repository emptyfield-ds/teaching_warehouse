...
knitr::include_graphics("function_call.png")
```
...
```{r, out.height="100%", out.width="100%", echo = FALSE}
knitr::include_graphics("function_call_fname.png")
```
...
```{r, out.height="100%", out.width="100%", echo = FALSE}
knitr::include_graphics("function_call_assignment.png")
```
...
```{r, out.height="100%", out.width="100%", echo = FALSE}
knitr::include_graphics("new_data_alert_diabetes.png")
```
