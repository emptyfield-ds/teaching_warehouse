...
1.  In `_targets.R`, we're sourcing `R/functions.R`. Open that file and take a look at the first function, `map_2010_forest_conversion()`. This function takes a dataframe---forest---and generates a map of forest conversion in 2010.
