...
knitr::include_graphics("images/my-pane-layout.png")
```
...
```{r, echo=FALSE, out.width="80%", out.height="80%"}
knitr::include_graphics("images/my-pane-layout-recursive.png")
```
...
knitr::include_graphics(path = "images/datapasta-reprex-spreadsheet.gif")
```
...
knitr::include_graphics(path = "images/reprex.png")
```
...
knitr::include_graphics("images/r-tag-stackoverflow.png")
```
...
.pull-right[![#rstats on twitter](images/welcome_to_rstats_twitter.png)]
